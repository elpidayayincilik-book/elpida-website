...
function AcademicPublish() {
  return (
    <div className="flex md:flex-row flex-col lg:gap-6 gap-4 justify-center  ">
      <div className="flex   md:justify-start md:items-start justify-center  relative w-full min-w-[300] max-h-[360]">
      ...
      <div className="flex flex-col gap-3">
        <p>
          Ücretsiz Paket’in diğer paketlerden ön önemli farkı; Yazar’ın kendi
          eserine duyduğu güvene dayalı olmasıdır. Yazar, eserini sahiplenmekte
          ve belirli sürede belirli adedinin satılacağına inanmaktadır.
        </p>
