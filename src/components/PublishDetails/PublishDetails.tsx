...
function PublishPackageContent({
  publishDetails,
}: {
  ...
  if (!publishDetails || publishDetails.length === 0) {
    return (
      <div className="p-8 text-center">
        <p>Yayın paketleri şu anda görüntülenemiyor.</p>
      </div>
    );
  }

  return <PublishPackageContent publishDetails={publishDetails} />;
}
